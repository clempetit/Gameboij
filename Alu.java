...
public final class Alu {
    ...
    /**
     * return a value whose bits corresponding to the different flags are equal
     * to 1 if and only if the argument is true and 0 otherwise.
     * 
     * @param z
     *            the boolean associated to the flag Z
     * @param n
     *            the boolean associated to the flag N
     * @param h
     *            the boolean associated to the flag H
     * @param c
     *            the boolean associated to the flag C
     * @return a value whose bits corresponding to the different flags are equal
     *         to 1 if and only if the argument is true and 0 otherwise
     */
     ...
     *            the integer (must be an 8 bits value)
     * @param c0
     *            the initial carry bit (0 if false and 1 if true)
     * @throws IllegalArgumentException
     *             if l or r is invalid
     * @return the sum of the two 8 bits values with the initial carry bit c0
     *         and the flags Z0HC
     */
     ...
     * are the flags corresponding to the addition of the 8 least significant
     * bits.
     * 
     * @param l
     ...
     * @throws IllegalArgumentException
     *             if l or r is invalid
     * @return the sum of the two 16 bits values and the flags 00HC where H and
     *         C are the flags corresponding to the addition of the 8 least
     *         significant bits
     */
    ...
    /**
     * return the sum of the two 16 bits values and the flags 00HC where H and C
     * are the flags corresponding to the addition of the 8 most significant
     * bits.
     * 
     * @param l
     *            the integer (must be a 16 bits value)
     ...
     *             if l or r is invalid
     * @return the sum of the two 16 bits values and the flags 00HC where H and
     *         C are the flags corresponding to the addition of the 8 most
     *         significant bits
     */
    ...
    /**
     * return the difference between the two 8 bits values with the initial
     * borrow b0, and the flags Z1HC.
     * 
     * @param l
     *            the integer (must be an 8 bits value)
     * @param r
     *            the integer (must be an 8 bits value)
     * @param b0
     *            the initial borrow (false is 0 and true is 1)
     * @throws IllegalArgumentException
     *             if l or r is invalid
     * @return the difference between the two 8 bits values with the initial
     *         borrow b0 and the flags Z1HC
    ...
    /**
     * return the "or"(inclusive) of the two given 8 bits values and the flags
     * Z000.
     * 
     * @param l
     *            the integer (must be an 8 bits value)
    ...
    /**
     * return the "xor"(exclusive) of the two given 8 bits values and the flags
     * Z000.
     * 
     * @param l
     *            the integer (must be an 8 bits value)
     ...
     *             if v is invalid
     * @return the given 8 bits value shifted of one bit to the left and the
     *         flags Z00C where C contains the bit ejected
     */
    ...
    /**
     * return the given 8 bits value shifted of one bit to the right in the
     * arithmetic way, and the flags Z00C where C contains the bit ejected
     ...
     *             if v is invalid
     * @return the given 8 bits value shifted of one bit to the right in the
     *         arithmetic way and the flags Z00C where C contains the bit
     *         ejected
     */
    ...
    /**
     * return the given 8 bits value shifted of one bit to the right in the
     * logic way, and the flags Z00C where C contains the bit ejected (false is
     * 0 and true is 1).
     * 
     * @param v
     *            the integer (must be an 8 bits value)
     ...
     *             if v is invalid
     * @return the given 8 bits value shifted of one bit to the right in the
     *         logic way and the flags Z00C where C contains the bit ejected
     */
    ...
    /**
     * return the rotation of one bit in the given direction of the given 8 bits
     * value, and the flags ZOOC where C contains the bit that went from an
     * extremity to the other during the rotation (false is 0 and true is 1).
     * 
     * @param d
     *            the direction
     * @param v
     ...
     * @throws IllegalArgumentException
     *             if v is invalid
     * @return the rotation of one bit in the given direction of the given 8
     *         bits value and the flags ZOOC where C contains the bit that went
     *         from an extremity to the other
     */
    ...
    /**
     * return the rotation through the carry in the given direction of the
     * combination of the given 8 bits value with the carry flag C, and the
     * flags Z00C where C contains the most significant bit.
     * 
     * @param d
     *            the direction
     * @param v
     ...
     *             if v is invalid
     * @return the rotation through the carry in the given direction of the
     *         combination of the given 8 bits value with the given carry c and
     *         the flags Z00C
     */
    public static int rotate(RotDir d, int v, boolean c) {
        Preconditions.checkBits8(v);
        int rotated = Bits.rotate(9, Bits.set(v, 8, c),
                (d.equals(RotDir.LEFT) ? 1 : -1));
    ...
    /**
     * return the value obtained exchanging the four least significant bits with
     * the four most significant bits of the given 8 bits value, and the flags
     * Z000.
     * 
     * @param v
     *            the integer (must be an 8 bits value)
     ...
     *             if v is invalid
     * @return the value obtained exchanging the four least significant bits with
     *         the four most significant bits of the given 8 bits value and the
     *         flags Z000
     */
    ...
    /**
     * return the value 0 and the flags Z010 where Z is true if and only if the
     * bit of the given index of the given 8 bits value is 0.
     * 
     * @param v
     *            the integer (must be an 8 bits value)
     * @param bitIndex
     *            the index (must be included between 0 and 7)
     * @throws IllegalArgumentException
     *             if v is invalid
     * @throws IndexOutOfBoundsException
     *             if bitIndex is invalid
     * @return the value 0 and the flags Z010 where Z is true if and only if the
     *         bit of the given index of the given 8 bits value is 0
     */
