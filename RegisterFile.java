...
public final class RegisterFile<E extends Register> {
    ...
    /**
     * builds a bench of 8 bits registers which size is the same as the size of
     * the given array.
     * 
     * @param allRegs
     *            the array
     ...
     * an integer included between 0 and FF.
     * 
     * @param reg
     *            the register
     * @return the 8 bits value contained in the given register in the form of
    ...
    /**
     * modifies the given register's content so that it is equal to the given 8
     * bits value.
     * 
     * @param reg
     *            the register
    ...
    /**
     * return true if and only if the given bit of the register is equal to 1.
     * 
     * @param reg
     *            the register
     * @param b
    ...
    /**
     * modifies the value contained in the given register so that the given bit
     * has the given new value.
     * 
     * @param reg
     *            the register
     * @param bit
