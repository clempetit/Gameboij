...
public final class RamController implements Component {
    ...
    /**
     * builds a controller for the given RAM, accessible between the start address and the end address
     * @param ram  the ram (must not be null)
     * @param startAddress the start address (must be a 16 bits value)
     * @param endAddress the end address (must be a 16 bits value)
     * @throws NullPointerException if the ram is null
     * @throws IllegalArgumentException if the start or the end address are invalid 
     * or if the interval they form is negative or superior to the size of the ram
     */
    ...
    /**
     * calls the first constructor with an end address such that the whole
     * RAM is accessible through the controller
     * @param ram the ram (must be a 16 bits value)
     * @param startAddress (must be a 16 bits value)
     */
